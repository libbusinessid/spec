...
LibEntID project a harassment-free experience for everyone, regardless of
...
- publishing a real business identifier belonging to an identifiable person, in
  violation of `DATA_POLICY.md`;
...
reported to the maintainers through the private security advisory channel of the
...
Maintainers will follow these enforcement guidelines: a private written warning,
then a temporary ban from any interaction, then a permanent ban, depending on
the severity and the repetition of the violation.

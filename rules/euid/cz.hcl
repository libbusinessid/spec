...
format "euid" "cz" {
  ...
  checks = [
    ...
    require(length_eq(capture.registration, 8), "invalid_length", "euid.cz.registration_length"),
    require(ascii_digits(capture.registration), "invalid_characters", "euid.cz.registration_characters"),
  ]
}
